...
% fileTx = 'lena.tiff'; % Image file name
% fData = imread(fileTx); % Read image data from file

load("pluto_tx_image.mat");
fData = img_w;
% imwrite(fData, 'pluto_img_QF.jpg', 'jpg', 'Quality', QF);
% fData = imread('pluto_img_QF.jpg');
...
% rawData_1 = readJpegRawData('pluto_img_QF.jpg');
% txImage = rawData_1(:);
...
if ~(isempty(fineTimingOffset) || isempty(pktOffset))
    ...
    % saveJpegRawData(decData, 'pluto_img_rx.jpg');
    % RxData_temp = imread('pluto_img_rx.jpg');
    ...
    save("pluto_rx_image.mat", "receivedImage")
    imwrite(receivedImage, 'com_rx.jpg', 'jpg');
end
